...
class __internal__():
    ...
    @staticmethod
    def check_params_result_error(transformer_params):
    ...
    @staticmethod
    def check_retrieve_results_error(transformer_retrieve):
    ...
    @staticmethod
    def load_metadata_files(metadata_files):
    ...
    @staticmethod
    def handle_retrieve_files(transformer_instance, args, metadata):
    ...
    @staticmethod
    def handle_result(result, result_types=None, result_file_path=None):
