...
from agpypeline import environment as env
...
class __internal__:
    ...
    def exif_tags_to_timestamp(exif_tags):
        ...
        """
        return env.__internal__.exif_tags_to_timestamp(exif_tags)
    ...
    def get_first_timestamp(file_path, timestamp):
        ...
        """
        return env.__internal__.get_first_timestamp(file_path, timestamp)
...
class Transformer:
    ...
    def add_parameters(self, parser):
        ...
        """
        env.Environment.add_parameters(self, parser)
